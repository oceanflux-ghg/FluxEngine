...
class k_CustomGtvTest(KCalculationBase):
    ...
    # For example k_CustomGtvTest_some_parameter is used here.
    ...
    def __init__(self, k_CustomGtvTest_some_parameter):
        ...
        self.someParameter = k_CustomGtvTest_some_parameter  # 'k_CustomGtvTest_some_parameter' needs to be defined in the configuration file
        #Note: the internal name (self.someParameter) can have any name it like and does not need to correspond to a configuration variable
