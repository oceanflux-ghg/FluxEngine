...
The opensource FluxEngine has so far contributed to 12 different journal publications, resulting in 4 press releases, contributed to 2 completed PhDs and 1 ongoing PhD, has been used within 5 UK and EU research projects and has been used in undergraduate and masters level teaching. This work collectively identifies and quantifies the importance of the oceans in regulating and storing carbon. 
