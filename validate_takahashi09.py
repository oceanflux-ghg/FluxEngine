...
fluxBudgetsArgs = Namespace(LooseIce=False, cidataset='OIC1', cwdataset='OSFC', dir=path.join(getcwd(), 'output/validate_takahashi09/'),
                            ...
                            outroot=path.join(getcwd(), 'output/validate_takahashi09/'), places=10, ref=None,
...
newOutputPath = "output/validate_takahashi09/_global.txt";
(colNames, vals) = read_global_core_budgets(newOutputPath);
